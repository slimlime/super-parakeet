...
void copy_sequence_number(const uint8_t* packet_start_src, uint8_t* packet_start_dst, 
	...
	packet_start_dst[seq_data_offset + PACKET_DATA_START + 0] = 
		packet_start_src[seq_data_offset + PACKET_DATA_START + 0];

	packet_start_dst[seq_data_offset + PACKET_DATA_START + 1] =
		packet_start_src[seq_data_offset + PACKET_DATA_START + 1];

	packet_start_dst[seq_data_offset + PACKET_DATA_START + 2] =
		packet_start_src[seq_data_offset + PACKET_DATA_START + 2];
}
